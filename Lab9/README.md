...
![image](https://user-images.githubusercontent.com/98097869/236336154-46af7a5d-7fb0-46df-ad3c-d1e442d93895.png)


### cat intrusiondetection.yang
```
PS C:\Users\stoll\demo> cat intrusiondetection.yang
...
### pyang -f yin -o intrusiondetection.yin intrusiondetection.yang
 - I had an issue with this code because it kept aksing for an application to open it rather than actually doing anything else. 
 - I played around with a few things but none of them gave me different results.
